...
# Load .env from streamlit_app directory (one level up from services/)
...
class Lakebase:
    ...
    def _create_connection(cls):
        ...
        """
        # Initialize Databricks SDK client (uses default environment authentication)
        cls._workspace_client = WorkspaceClient()
        
        # Get OAuth token from workspace client config
